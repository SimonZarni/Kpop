              ...
              <div class="col-md-4 mb-5">
                <div class="box1 rounded-4">
                  <div class="h-75 reviewText ">
                    <p class="p-2"><span><img src="public/images/quote.jpg" width="25px" height="30px" class="mx-1" alt=""></span><?= $review['review'] ?><span><img src="public/images/quote1.jpg" width="25px" height="30px" class="mx-1" alt=""></span></p>
                  </div>
                  <div class="first">
                    <div class="rating">
                      <?php
  ...
  if ($hasOrder) {
      echo '<div class="container d-flex justify-content-center">
              <div class="alert alert-info w-50 text-center">
                <p class="text-center">Your honest reviews are welcome!!!</p>
