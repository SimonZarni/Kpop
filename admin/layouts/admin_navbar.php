        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="../agent/agent.php">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="../group/group.php">
                            <i class="align-middle" data-feather="user-plus"></i> <span class="align-middle">Group</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="../voucherCode/code.php">
                            <i class="align-middle" data-feather="credit-card"></i> <span class="align-middle">Voucher Code</span>
                        </a>
                    </li>

                    <li class=" sidebar-item nav-item dropdown">
                        <a href="#" class="btn btn-dark dropdown-toggle sidebar-link" data-bs-toggle="dropdown">
                            <i class="align-middle" data-feather="trending-up"></i> <span class="align-middle">Stock Management</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-dark">
                            <li><a class="dropdown-item" href="../stock/stock.php"> <i class="align-middle" data-feather="database"></i><span class="align-middle">Stock</span></a></li>
                    ...
                    <li class="sidebar-item nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                            <li><a class="dropdown-item" href="../report/monthly_report.php"> <i class="align-middle" data-feather="bar-chart"></i><span class="align-middle">Monthly Report</span></a></li>
                            <li><a class="dropdown-item" href="../report/yearly_report.php"><i class="align-middle" data-feather="bar-chart"></i> <span class="align-middle">Yearly Report</span></a></li>
                        </ul>
                    </li>

                    <li class="sidebar-item">
                        <a class="sidebar-link" href="../city/city.php">
                            <i class="align-middle" data-feather="globe"></i> <span class="align-middle">City</span>
                        </a>
                    </li>
                    ...
                    <ul class="navbar-nav navbar-align">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                                ...
                                <?php echo is_array($userInfo) && isset($userInfo['name']) ? '<i class="align-middle me-1" data-feather="user"></i> ' . $userInfo['name'] : ''; ?>
                                </span>
                            </a>

                            <div class="dropdown-menu dropdown-menu-end">

                                <a class="dropdown-item mt-2" href="../../view/features/changePassword.php"><i class="align-middle me-1" data-feather="key"></i> Change Password </a>
