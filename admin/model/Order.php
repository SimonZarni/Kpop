...
class Order
{
    public function getOrderList()
    {
        ...
        //2.write sql
        $sql = "SELECT  order_detail.order_code as code , order_detail.voucher_code as voucher_code , user.name as name,  order_detail.order_date as date , order_detail.status as status
                FROM order_detail
    ...
    public function getProfit()
    {
        ...
        SUM( (orders.quantity * product.price) - (orders.quantity * stock_details.buy_priceEach)) AS total
    FROM
        orders
